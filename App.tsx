...
const App: React.FC = () => {
  ...
  // Force scroll to top on page load to prevent browser's scroll restoration bug
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const now = Date.now();
    const imageUrls = [
        'https://res.cloudinary.com/ddmsvxkdm/image/upload/v1753255472/wd3dapnnr3tco86udik5.jpg', // Placeholder for Hive 1
...
Remember to respond as Bwise, the friendly apiculturist.`;
    ...
    try {
        ...
        const modelResponse = response.text || "Sorry, I received an empty response.";
